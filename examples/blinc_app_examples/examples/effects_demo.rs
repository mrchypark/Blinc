                    ...
                    div()
                        ...
                        .child(
                            ...
                            div()
                                ...
                                .h(80.0)
                                .rounded(12.0)
                                .material(Material::Glass(GlassMaterial::simple().blur(12.0)))
                    ...
                    div()
                        ...
                        .child(
                            div()
                                ...
                                .h(60.0)
                                .rounded(8.0)
                                .material(Material::Glass(GlassMaterial::simple().blur(5.0)))
                        ...
                        .child(
                            div()
                                ...
                                .h(60.0)
                                .rounded(8.0)
                                .material(Material::Glass(GlassMaterial::simple().blur(20.0)))
                                .border(1.0, Color::rgba(1.0, 1.0, 1.0, 0.15))
                                .flex()
                                .items_center()
                                .justify_center()
