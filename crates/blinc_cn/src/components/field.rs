...
#[derive(Clone)]
struct SharedElementBuilder {
    inner: Arc<dyn ElementBuilder>,
}

impl SharedElementBuilder {
    fn new(inner: impl ElementBuilder + 'static) -> Self {
        Self {
            inner: Arc::new(inner),
        }
    }
...
impl ElementBuilder for SharedElementBuilder {
...
pub(crate) struct FieldConfig {
    ...
    full_width: bool,
    gap: Option<f32>,
    children: Vec<SharedElementBuilder>,
}
...
impl FieldBuilder {
    ...
    pub fn child(mut self, child: impl ElementBuilder + 'static) -> Self {
        self.config.children.push(SharedElementBuilder::new(child));
        self
    }
